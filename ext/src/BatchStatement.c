...
static HashTable *
php_driver_batch_statement_properties(zend_object *object)
{
...
php_driver_batch_statement_new(zend_class_entry *ce)
{
  php_driver_statement *self =
      (php_driver_statement *) zend_object_alloc(sizeof(php_driver_statement), ce);
  ...
  self->std.handlers = &php_driver_batch_statement_handlers;
