...
#  error PHP 8.3.0 or later is required to build this extension
#endif
...
#endif
#ifndef ZEND_ACC_NOT_CLONEABLE
#  define ZEND_ACC_NOT_CLONEABLE 0
#endif

/* Define TSRMLS_* macros for PHP 8.0+ */
...
#   define TSRMLS_SET_CACHE(ptr)
#   define TSRMLS_CACHE
#   define TSRMLS_CACHE_DEFINE()
#   define TSRMLS_CACHE_UPDATE()
#   define TSRMLS_THREAD_SAFE_CACHE
#   define TSRMLS_FETCH_FROM_CTX(ctx)
#   define TSRMLS_CC_CC ,
#   define TSRMLS_CACHE_UPDATE_IF_CHANGED()
#   define TSRMLS_CACHE_DEFINE_INI_BOOL(name, default_value, on_modify, displayer, doc_root, arg_extra) \
       REGISTER_INI_ENTRY_EX(name, default_value, on_modify, displayer, doc_root, arg_extra)
# endif
#endif
